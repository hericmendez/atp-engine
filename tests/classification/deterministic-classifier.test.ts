...
describe('DeterministicClassifier', () => {
  ...
  describe('basic category classification', () => {
    it('classifies GAME from Steam type hint', () => {
    ...
    it('classifies DLC from Steam type hint', () => {
      const candidate = makeCandidate({
    ...
    it('classifies SOUNDTRACK from Steam type hint', () => {
      const candidate = makeCandidate({
        classificationHints: [
    ...
    it('classifies MOVIE from Wikipedia infobox', () => {
      const candidate = makeCandidate({
        classificationHints: [
    ...
    it('classifies TV_SHOW from Wikipedia categories', () => {
      const candidate = makeCandidate({
        classificationHints: [
          {
            category: 'TV_SHOW',
    ...
    it('classifies ANIME from Wikipedia categories', () => {
      const candidate = makeCandidate({
        classificationHints: [
    ...
    it('classifies BOOK from title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('classifies HARDWARE from Wikipedia infobox', () => {
      const candidate = makeCandidate({
        classificationHints: [
    ...
    it('classifies CHARACTER from title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('classifies FRANCHISE from title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('classifies PERSON from title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('classifies EVENT from title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('classifies PROMOTIONAL from title pattern', () => {
      const candidate = makeCandidate({
  ...
  describe('platform independence', () => {
    it('does not classify as GAME based on PC platform', () => {
      const candidate = makeCandidate({
    ...
    it('does not classify as GAME based on Android platform', () => {
      const candidate = makeCandidate({
    ...
    it('does not classify as GAME based on iOS platform', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown App', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on PlayStation platform', () => {
      const candidate = makeCandidate({
    ...
    it('does not classify as GAME based on Xbox platform', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown Title', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on Nintendo platform', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown Title', type: 'primary' }],
        releases: [
          {
  ...
  describe('distribution independence', () => {
    it('does not classify as GAME based on Steam distribution', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown Software', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on Epic distribution', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown Software', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on GOG distribution', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown Software', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on Google Play distribution', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown App', type: 'primary' }],
        releases: [
          {
    ...
    it('does not classify as GAME based on App Store distribution', () => {
      const candidate = makeCandidate({
        titles: [{ value: 'Unknown App', type: 'primary' }],
        releases: [
          {
  ...
  describe('mobile classification', () => {
    it('classifies Android app as GAME when source provides GAME hint', () => {
      const candidate = makeCandidate({
    ...
    it('returns UNKNOWN for Android app without game evidence', () => {
      const candidate = makeCandidate({
    ...
    it('classifies iOS app as GAME when source provides GAME hint', () => {
      const candidate = makeCandidate({
    ...
    it('returns UNKNOWN for iOS app without game evidence', () => {
      const candidate = makeCandidate({
    ...
    it('returns UNKNOWN for APK without game evidence', () => {
      const candidate = makeCandidate({
    ...
    it('classifies delisted Android game as GAME', () => {
      const candidate = makeCandidate({
  ...
  describe('PC classification', () => {
    it('classifies Windows app as GAME when source provides GAME hint', () => {
      const candidate = makeCandidate({
    ...
    it('classifies Windows DLC when source provides DLC hint', () => {
      const candidate = makeCandidate({
    ...
    it('returns UNKNOWN for Windows software without game evidence', () => {
      const candidate = makeCandidate({
    ...
    it('classifies delisted PC game as GAME', () => {
      const candidate = makeCandidate({
    ...
    it('classifies abandonware as GAME when evidence supports it', () => {
      const candidate = makeCandidate({
  ...
  describe('source hint priority', () => {
    it('Steam type hint has higher weight than title pattern', () => {
      const candidate = makeCandidate({
    ...
    it('title SOUNDTRACK pattern overrides weak source hint', () => {
      const candidate = makeCandidate({
  ...
  describe('conflicting signals', () => {
    it('resolves conflict by weighted scoring', () => {
      const candidate = makeCandidate({
  ...
  describe('UNKNOWN classification', () => {
    ...
    it('returns UNKNOWN when signals are below threshold', () => {
      const candidate = makeCandidate({
  ...
  describe('remakes, remasters, ports', () => {
    ...
    it('classifies remaster as GAME', () => {
      const candidate = makeCandidate({
  ...
  describe('difficult edge cases', () => {
    it('The Sims 4: Get to Work is classified by source hint, not title', () => {
      const candidate = makeCandidate({
    ...
    it('Doom Eternal is classified as GAME, not DLC', () => {
      const candidate = makeCandidate({
    ...
    it('Game Demo with game hint is classified as GAME', () => {
      const candidate = makeCandidate({
    ...
    it('homebrew port classified by available evidence', () => {
      const candidate = makeCandidate({
  ...
  describe('signal tracking and explainability', () => {
    it('records all signals used for classification', () => {
      const candidate = makeCandidate({
    ...
    it('includes reason explaining classification', () => {
      const candidate = makeCandidate({
        classificationHints: [{ category: 'GAME', confidence: 0.9, evidence: 'Steam type: game' }],
      });
      const result = classifier.classify(candidate);
  ...
  describe('EXPANSION category', () => {
    it('classifies expansion from source hint', () => {
      const candidate = makeCandidate({
    ...
    it('classifies expansion from title pattern', () => {
      const candidate = makeCandidate({
  ...
  describe('description-based classification', () => {
    it('classifies GAME from description keywords', () => {
      const candidate = makeCandidate({
    ...
    it('classifies SOUNDTRACK from description keywords', () => {
      const candidate = makeCandidate({
    ...
    it('classifies MOVIE from description keywords', () => {
      const candidate = makeCandidate({
